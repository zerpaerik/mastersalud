  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">{{$paquete->nombre}}</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">Agregar servicios y/o laboratorios a paquete</h3>
              </div>
              <!-- /.card-header -->
              <!-- form start -->
              <form method="post" action="paquetes/editar" accept-charset="UTF-8" enctype="multipart/form-data">					
              {{ csrf_field() }}                
