            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                   ...
                   <div class="col-md-4">
                    ...
                    <form method="post" action="historiasm/edit" accept-charset="UTF-8" enctype="multipart/form-data">					
                    {{ csrf_field() }} 
              <div class="card-body">
                   ...
                   <div class="row">
                    ...
                    <input type="text" onkeyup="javascript:this.value=this.value.toUpperCase();"  class="form-control" id="nombre" name="piel" placeholder=""  value="{{$historias->piel}}">
                   </div>
                   <div class="col-md-6">
                    <label for="exampleInputEmail1">Torax</label>
                    <input type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" class="form-control" id="nombre" name="torax" placeholder="" value="{{$historias->torax}}">
                   </div>
                    ...
                    <input type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" class="form-control" id="nombre" name="corazon" placeholder=""  value="{{$historias->corazon}}">
                   </div>
                     <div class="col-md-6">
                    <label for="exampleInputEmail1">Abdomen</label>
                    <input type="text" onkeyup="javascript:this.value=this.value.toUpperCase();"  class="form-control" id="nombre" name="abdomen" placeholder=""  value="{{$historias->abdomen}}">
                   </div>
                    ...
                    <div class="col-md-6">
                    <label for="exampleInputEmail1">Otros</label>
                    <input type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" class="form-control" id="nombre" name="otros" placeholder=""  value="{{$historias->otros}}">
                   </div>
                    ...
                    <textarea class="form-control" onkeyup="javascript:this.value=this.value.toUpperCase();" rows="3"  name="ex_aux" placeholder="Examen Auxiliar">{{$historias->ex_aux}}</textarea>
                  </div>
                    </div>
                    ...
                    <textarea class="form-control" onkeyup="javascript:this.value=this.value.toUpperCase();" rows="2"  name="diag_fin" placeholder="Diagnóstico Final" >{{$historias->diag_fin}}</textarea>

                   </div>
                   <div class="col-md-6">
                    <label for="exampleInputEmail1">CIE X</label>
                    <input type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" class="form-control" id="nombre" name="cie_df" placeholder=""  value="{{$historias->cie_df}}">
                    ...
                    <textarea class="form-control" onkeyup="javascript:this.value=this.value.toUpperCase();" rows="3"  name="plan" placeholder="Examen Auxiliar" >{{$historias->plan}}</textarea>
                  </div>
                    </div>
                    ...
                    <textarea class="form-control" onkeyup="javascript:this.value=this.value.toUpperCase();" rows="3"  name="observaciones" placeholder="Observaciones" >{{$historias->observaciones}}</textarea>
                  </div>
                    </div>
