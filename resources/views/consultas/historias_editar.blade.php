            ...
            <div class="card card-primary">
              ...
              <div class="row">
                   ...
                   <div class="col-md-4">
                    ...
                    <form method="post" action="historias/edit" accept-charset="UTF-8" enctype="multipart/form-data">					
                    {{ csrf_field() }} 
                    <div class="row">
                     <div class="col-md-12">
                    <label for="exampleInputEmail1">Motivo de Consulta</label>
                    <input type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" class="form-control" id="nombre"   name="motivo" value="{{$hist->motivo}}">
                   ...
                   <div class="col-md-4">
                    ...
                    <input type="text" onkeyup="javascript:this.value=this.value.toUpperCase();"  class="form-control"  id="nombre" name="ext" placeholder=""  value="{{$hist->ext}}">
                   </div>
                   <div class="col-md-4">
                    <label for="exampleInputEmail1">Genitales Internos</label>
                    <input type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" class="form-control"  id="nombre" name="int" placeholder=""  value="{{$hist->int}}">
                   </div>
                   <div class="col-md-4">
                   ...
                   <div class="row">
                    ...
                    <input type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" class="form-control" id="nombre"   name="obser" value="{{$hist->obser}}">
                   </div>
                    </div>
                   <div class="row">
                     <div class="col-md-3">
                    ...
                    <input type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" class="form-control" id="nombre"   name="observacion" value="{{$hist->observacion}}">
                   </div>
                    </div>
                    <div class="row">
                     <div class="col-md-12">
                    <label for="exampleInputEmail1">Reevaluado Por:</label>
                    <input type="text" onkeyup="javascript:this.value=this.value.toUpperCase();" class="form-control" id="nombre"   name="usuario_reevalua" value="{{$hist->usuario_reevalua}}">
                   </div>
                    </div>
