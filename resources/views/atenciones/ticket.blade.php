<head>
	...
	<div class="" style="font-size: 35px; text-align: center;margin-bottom: 15px;">
		<img src="/var/www/html/mt/mastersalud/public/logo_negro.png"  style="width: 80%; color: black;"/>
	</div>
    ...
    <p style="margin-left: -40px;margin-top: -10px;"><strong>ORIGEN:</strong> {{ $header->lasto}}, {{ $header->nameo}}</p>
