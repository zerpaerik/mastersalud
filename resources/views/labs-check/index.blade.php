  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Laboratorios por Recepcionar</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Laboratorios por Recepcionar</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
      ...
      <div class="card">
              ...
              <label><input type="checkbox" id="checkTodos" />Seleccionar Todos</label>
                ...
                <form action="/checkmultiple" method="post">
                  ...
                  <th>
								{{ csrf_field() }}
								<button style="margin-left: -5px;" type="submit" onclick="return confirm('¿Desea Chequear estos Analisis?')" class="btn btn-xs btn-danger">Chequear.Selecc.</button>
